...
fid = fopen('../example b/Result.txt','w');
...
str1 = sprintf(['../example b/input_file_beam_prob_b_',int2str(ii)]);
...
fid = fopen('../example b/Result.txt','a');

fprintf(fid,'\n\n===========================================================\n');
fprintf(fid,'\nNumber of Elements used = %d\n',nele);
fprintf(fid,'E = %12.4e\nI = %12.4e\n\n',E0,Ie0);
...
fprintf(fid,'\nReaction Force at Cantilever end = %.2fN\n',Freac(1));
...
% Analytial Rotation and deflection
% ---------------------------------

% output of the function: x analytical, displacement analytical, 

% rotation analytical

[x_ana,u_ana,theeta_ana] = analytical(E0,Ie0,q0,F0,L1,L2);  

subplot(1,2,1)
plot(x_ana,u_ana,'--k');
legend('No.of Elements = 3','No of Elements = 6','No of Elements = 7','Analytical');
hold on
subplot(1,2,2)
plot(x_ana,theeta_ana,'--k');
legend('No.of Elements = 3','No of Elements = 6','No of Elements = 7','Analytical');
hold on
saveas(h,'../example b/output_graph','fig');
